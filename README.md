...
- [x] 讯盟小程序的预览二维码改为小程序码，并提示使用 支持小程序的客户端打开
...
- [x] 页面方法添加内置函数可选项
- [x] 内置函数的插入根据当前光标的位置来定
- [x] 编辑器 ctrl + s 保存

> 20/09/10

- [x] 自定义节点的编辑器，左侧给出当前页面的视图模型和页面方法
- [x] 内部 parse code 报错时，打印错误栈
...
- [x] 项目添加选项，将上传的图片下载到本地，改为相对路径引用

> 20/10/14

- [x] 优化自定义节点：去除外层包裹，支持 slot

> 20/10/15

- [x] 小程序 sdk 组件内置引用，而不是扫码才能预览

- 20/11/01

- [ ] 添加 pc 排版，尺寸 1367*779，缩放整个界面 
