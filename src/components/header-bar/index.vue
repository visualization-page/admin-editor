<template>
  <div>
    <div class="app-header__bar flex-center-between plr20 relative">
      <div class="absolute-center">
        <span class="b f12">{{ project.dir ? `编辑 - ${project.dir}` : '新建项目' }}</span>
      </div>
      ...
      <div v-show="showSearchModal" class="search-wrap" @click.stop="">
...
export default defineComponent({
  setup (props, ctx) {
    ...
    watch(() => showSearchModal.value, val => {
      if (val) {
